...
public class ChartPluginActivity extends AbstractPluginActivity implements
		PluginActivity {

	public ChartPluginActivity(Context context) {
		super(context);
	}
	...
	public Class<? extends Activity> getActivityClass() {
		// TODO - make specific list for temperatures only
